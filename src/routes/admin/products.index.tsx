...
import { getProductsWithPagination, toggleProductStatus, bulkDeleteProducts, bulkDraftProducts } from "~/queries/products.server"
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Upravljajte proizvodima i cenama</p>
        </div>
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Da li ste sigurni da želite da obrišete {selectedIds.size} proizvod(a)? Ova akcija se ne može poništiti.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
