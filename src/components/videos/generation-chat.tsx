            ...
            <div className="flex items-center justify-center min-h-[400px]">
              <Empty>
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Opišite video koji želite da kreirate. Možete biti specifični ili pitati AI za predloge.
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            </div>
                    ...
                    {msg.role === "assistant" && msg.videoId && (
                      <div className="mt-2 inline-flex items-center gap-3 p-3 border rounded-lg bg-background">
                        <img
                          ...
                          className="w-20 h-12 bg-muted rounded overflow-hidden object-cover flex-shrink-0"
                        />
