import { pgTable, text, timestamp, foreignKey, unique, boolean, uuid, jsonb, numeric, integer, pgEnum } from "drizzle-orm/pg-core"
...
export const videoStatus = pgEnum("video_status", ['pending', 'generating', 'ready', 'failed'])
