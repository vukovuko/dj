...
import { user, account, session, categories, products, videoGenerationChats, videos, tables, tableOrders } from "./schema";
...
export const videoGenerationChatsRelations = relations(videoGenerationChats, ({one}) => ({
	user: one(user, {
